...
## Javascript Assignments  [![Build Status](https://travis-ci.org/Mag641/Travis-test.svg?branch=master)](https://travis-ci.org/Mag641/Travis-test)
...
```
* Open https://github.com/Mag641/Travis-test and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/Mag641/Travis-test/builds).
